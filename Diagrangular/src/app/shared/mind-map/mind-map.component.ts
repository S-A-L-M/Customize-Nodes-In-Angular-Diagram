...
import { ConnectorModel, Diagram, DiagramComponent, NodeModel, PointPortModel } from '@syncfusion/ej2-angular-diagrams';
import { DataManager } from '@syncfusion/ej2-data';
import { mindMapData } from '../models/data-mind-models';
